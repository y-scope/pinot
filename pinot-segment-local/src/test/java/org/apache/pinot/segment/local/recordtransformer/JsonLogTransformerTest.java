...
public class JsonLogTransformerTest {
  ...
  public void testOverlappingSchemaFields() {
    Assert.assertThrows(IllegalArgumentException.class, () -> {
      ...
      new JsonLogTransformer(createDefaultTableConfig(INDEXABLE_EXTRAS_FIELD_NAME, null, null, null), schema);
    });
  ...
  public void testInvalidFieldNamesInSchema() {
    ...
    Assert.assertThrows(() -> {
      ...
      new JsonLogTransformer(
          createDefaultTableConfig(INDEXABLE_EXTRAS_FIELD_NAME, null, UNINDEXABLE_FIELD_SUFFIX, null), schema);
    });
    ...
    Assert.assertThrows(() -> {
      ...
      new JsonLogTransformer(createDefaultTableConfig(INDEXABLE_EXTRAS_FIELD_NAME, null, null, fieldPathsToDrop),
          schema);
    });
  }
