...
public class CLPForwardIndexCreatorV2Test {
  ...
  public void testCLPWriter()
    ...
    CLPForwardIndexCreatorV2 clpForwardIndexCreatorV2 =
        new CLPForwardIndexCreatorV2(TEMP_DIR, "column1", logLines.size(), statsCollector);
    ...
    for (int i = 0; i < logLines.size(); i++) {
      Assert.assertEquals(clpForwardIndexReaderV2.getString(i, clpForwardIndexReaderV2.createContext()),
          logLines.get(i));
    }
  }
