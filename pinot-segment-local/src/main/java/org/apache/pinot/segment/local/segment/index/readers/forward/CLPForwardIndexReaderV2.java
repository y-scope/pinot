...
public class CLPForwardIndexReaderV2 implements ForwardIndexReader<CLPForwardIndexReaderV2.CLPReaderContext> {
  ...
  private final FixedByteChunkSVForwardIndexReader _logTypeFwdIndexReader;
  private final int _dictVarsFwdIndexReaderStartOffset;
  private final VarByteChunkForwardIndexReaderV5 _dictVarsFwdIndexReader;
  private final int _encodedVarFwdIndexReaderStartOffset;
  private final VarByteChunkForwardIndexReaderV5 _encodedVarFwdIndexReader;
  ...
  public CLPForwardIndexReaderV2(PinotDataBuffer pinotDataBuffer, int numDocs) {
    ...
    _logTypeFwdIndexReader =
        new FixedByteChunkSVForwardIndexReader(pinotDataBuffer.view(offset, offset + logTypeFwdIndexLength),
            FieldSpec.DataType.INT);
    offset += logTypeFwdIndexLength;

    _dictVarsFwdIndexReaderStartOffset = offset;
    _dictVarsFwdIndexReader =
        new VarByteChunkForwardIndexReaderV5(pinotDataBuffer.view(offset, offset + dictVarsFwdIndexLength),
  ...
  public String getString(int docId, CLPReaderContext context) {
    int logTypeDictId = _logTypeFwdIndexReader.getInt(docId, context._logTypeReaderContext);
    ...
    int[] dictVarsDictIds = _dictVarsFwdIndexReader.getIntMV(docId, context._dictVarsReaderContext);
  ...
  public static final class CLPReaderContext implements ForwardIndexReaderContext {
    private final VarByteChunkForwardIndexReaderV5.ReaderContext _dictVarsReaderContext;
    private final ChunkReaderContext _logTypeReaderContext;
    private final VarByteChunkForwardIndexReaderV5.ReaderContext _encodedVarReaderContext;

    public CLPReaderContext(VarByteChunkForwardIndexReaderV5.ReaderContext dictVarsReaderContext,
        ChunkReaderContext logTypeReaderContext,
