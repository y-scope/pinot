...
/**
 * Configuration for the JSONLogRecordExtractor. There are a few configuration properties:
 * <p></p>
 * <b>fieldsForClpEncoding</b> - A comma-separated list of fields that should be encoded using CLP. Each field encoded
 * by {@link JSONLogRecordExtractor} will result in three output fields prefixed with the original field's name.
 * See {@link JSONLogRecordExtractor} for details. If <b>fieldsForCLPEncoding</b> is empty, no fields will be encoded.
 * <p></p>
 * <ul>
 *   <li><b>fieldsForClpEncoding</b> - A comma-separated list of fields that should be encoded using CLP. Each field
 *   encoded by {@link JSONLogRecordExtractor} will result in three output fields prefixed with the original field's
 *   name. See {@link JSONLogRecordExtractor} for details. If <b>fieldsForCLPEncoding</b> is empty, no fields will be
 *   encoded.</li>
 ...
 *     use-case (see {@link JSONLogRecordExtractor} for details);</li>
 ...
 *   called "binary_noIndex", then this field would end up in the <b>jsonDataNoIndex</b> field.
...
public class JSONLogRecordExtractorConfig implements RecordExtractorConfig {
  ...
  public static final String JSON_DATA_FIELD_CONFIG_KEY = "jsonDataField";
  public static final String JSON_DATA_NO_INDEX_FIELD_CONFIG_KEY = "jsonDataNoIndexField";
  public static final String JSON_DATA_NO_INDEX_SUFFIX_CONFIG_KEY = "jsonDataNoIndexSuffix";
  ...
  public void init(Map<String, String> props) {
    ...
    if ((null != _jsonDataNoIndexFieldName && null == _jsonDataNoIndexSuffix) || (null == _jsonDataNoIndexFieldName
        && null != _jsonDataNoIndexSuffix)) {
